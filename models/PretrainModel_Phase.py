...
class Vib2Mol_Phase(BaseModel):
    ...
    def forward(self, input, 
        ...
        if self.phase == 1:
            ...
            causal_tokens = self.molecular_decoder(casual_molecular_embeds, spectral_output['hidden_states'], 
...
@register_model
def vib2mol_phase(pretrained=False, **kwargs):
    model = Vib2Mol_Phase(encoder_nlayer=6, decoder_nlayer=6, **kwargs)
    if pretrained:
        url = "https://huggingface.co/xinyulu/vib2mol/resolve/main/checkpoints/mols/raman-kekule_smiles/vib2mol_phase.pth?download=true"
