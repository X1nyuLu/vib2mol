...
MODEL_NAME="vib2mol_matching_shared"
DATASET="qm9s"
...
# echo "Starting vib2mol retrieval performance evaluation script..."
# echo "---------------------------------------------------------"
...
# RANK_MODEL_PATH="checkpoints/qm9s/ir-kekule_smiles/vib2mol_matching_shared/2025-07-08-02-55-db43f7/epoch999.pth" 
# # Test model path for IR (without chemical formula)
# TEST_MODEL_PATH="checkpoints/qm9s/ir-kekule_smiles/vib2mol_matching_shared/2025-07-10-01-45-46b8b6/epoch999.pth"
...
# TEST_MODEL_PATH="checkpoints/qm9s/ir-kekule_smiles-formula/vib2mol_matching_shared/2025-07-12-02-02-4afc55/epoch999.pth"
...
# TEST_MODEL_PATH="checkpoints/qm9s/raman-kekule_smiles/vib2mol_matching_shared/2025-07-07-07-51-af1552/epoch999.pth"
# # Re-ranking model path for Raman
# RANK_MODEL_PATH="checkpoints/qm9s/raman-kekule_smiles/vib2mol_matching_shared/2025-07-06-12-15-bbe117/epoch999.pth" 
...
# TEST_MODEL_PATH="checkpoints/qm9s/raman-kekule_smiles-formula/vib2mol_matching_shared/2025-07-12-02-01-7839c0/epoch999.pth"
...
echo "Evaluating retrieval performance for QM9s-Raman-IR (with chemical formula)..."
SPECTRAL_TYPE="ir-raman"
TEST_MODEL_PATH="checkpoints/qm9s/ir-raman-kekule_smiles-formula/vib2mol_matching_shared/2025-07-19-03-47-7c9f30/epoch999.pth"
RANK_MODEL_PATH="checkpoints/qm9s/ir-raman-kekule_smiles/vib2mol_matching_shared/2025-07-11-06-32-9005f4/epoch999.pth" 
...
MODEL_NAME="vib2mol_matching_shared" # Redefining for clarity, though it's the same value
DATASET="mols"
...
# RANK_MODEL_PATH="checkpoints/mols/ir-kekule_smiles/vib2mol_matching_shared/2025-07-08-02-55-6ac6f2/epoch999.pth" 
# # Test model path for VB-mols IR (without chemical formula)
# TEST_MODEL_PATH="checkpoints/mols/ir-kekule_smiles/vib2mol_matching_shared/2025-07-10-07-42-dde12a/epoch999.pth"
...
# TEST_MODEL_PATH="checkpoints/mols/ir-kekule_smiles-formula/vib2mol_matching_shared/2025-07-14-07-06-e44b51/epoch999.pth"
...
# RANK_MODEL_PATH="checkpoints/mols/raman-kekule_smiles/vib2mol_matching_shared/2025-07-08-02-56-69bd7e/epoch999.pth" 
# # Test model path for VB-mols Raman (without chemical formula)
# TEST_MODEL_PATH="checkpoints/mols/raman-kekule_smiles/vib2mol_matching_shared/2025-07-10-07-46-68d484/epoch999.pth"
...
# TEST_MODEL_PATH="checkpoints/mols/raman-kekule_smiles-formula/vib2mol_matching_shared/2025-07-14-07-06-8a587e/epoch999.pth"
...
echo "Evaluating retrieval performance for VB-mols-Raman-IR (with chemical formula)..."
SPECTRAL_TYPE="ir-raman"
TEST_MODEL_PATH="checkpoints/mols/ir-raman-kekule_smiles-formula/vib2mol_matching_shared/2025-07-14-07-07-e1c1f4/epoch999.pth"
RANK_MODEL_PATH="checkpoints/mols/ir-raman-kekule_smiles/vib2mol_matching_shared/2025-07-12-01-38-833d2d/epoch999.pth" 
